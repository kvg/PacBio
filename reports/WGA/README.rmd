...
variants.illumina = read.table(paste(results.dir, "illumina/variants.vcf", sep="/"), header=FALSE, stringsAsFactors=FALSE, comment.char="#", col.names=c("CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "3D7"));
